...
-->
			  ...
			  <li class="menu-close"> <a class="menu__item__link js-menu__item__link" href="<?php echo home_url( '/' ); ?>inquiry/">お問い合わせ <span>Contact</span></a>
<!--
				<ul class="submenu">
...
-->
						...
						<ul>
						  ...
						  <li class="fismenu menu-close icon_menu_arrow"> <a class="menu__item__link js-menu__item__link" href="<?php echo home_url( '/' ); ?>inquiry/">お問い合わせ <span>Contact</span></a>
<!--
							<ul class="submenu">
							  <li class="submenu__item"> <a class="nav-close-menu" href="<?php echo home_url( '/' ); ?>">サブメニュー</a> </li>
							  <li class="submenu__item"> <a class="nav-close-menu" href="<?php echo home_url( '/' ); ?>">サブメニュー</a> </li>
						...
						<div>
							...
							<ul class="office-list">
								<li class="offis-item">
									...
									<p class="office-acssec">〒549-0001<br>大阪府泉佐野市泉州空港北1番地<br>関西国際空港航空会社ビル4階<span class="map"><a class="map-link" href="<?php echo home_url( '/' ); ?>">MAP</a></span></p>
								</li>
								<li class="offis-item">
									<p class="office-name">関西エアポートオペレーションサービス株式会社<br>伊丹オフィス</p>
									<p class="office-acssec">〒560-0036<br>大阪府豊中市蛍池西町3丁目555番地<span class="map"><a class="map-link" href="<?php echo home_url( '/' ); ?>">MAP</a></span></p>
								</li>
							</ul>
						</div>
						
						
						<div class="footer-btn"><a href="<?php echo home_url( '/' ); ?>"><img src="<?php bloginfo('template_url'); ?>/assets/img/common/logo_en.svg" alt="関西エアポートエアポートオペレーションサービス株式会社"></a><span>関西エアポート株式会社</span></div>
					</div>
				</div>
				
			</div>
			<div class="content-inner">
				<div class="footer-copylink-area">
					<ul class="footer-link-list">
						<li class="footer-link-item"><a href="<?php echo home_url( '/' ); ?>">クッキーポリシー</a></li>
						<li class="footer-link-item"><a href="<?php echo home_url( '/' ); ?>">個人情報保護方針</a></li>
