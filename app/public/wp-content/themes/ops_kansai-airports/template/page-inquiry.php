...
<div class="sub-page-header p-side-3-8">
  ...
  <div class="page-header__titles">
    ...
    <p class="page-header__subtitle">Contact</p>
  </div>
</div>
		...
		<div class="p-side-3-16">
			<div class="">
				<div class="left-content">
					<div class="read">
						<p class="read-ttl"><span class="sub-ttl">営業のご案内</span>「空港での安全を保証し、<br>お客様の信頼にお応えします。」</p>
							...
							<div class="left-content">
								<div class="security-outer">
									<div class="margin-adjust">
										<h2 class="left-pinkline-ttl">受託警備業務</h2>
									</div>
									<div class="security">
										<p class="left-border-ttl">関西国際空港</p>
										<ol class="disc-list">
											<li class="disc-item">空港制限区域への出入り管理業務</li>
											<li class="disc-item">空港内施設の警備業務</li>
							...
							<div class="left-content">
								<div class="security-outer">
									...
									<div class="security">
										<p class="left-border-ttl">関西国際空港</p>
										<ol class="disc-list">
											<li class="disc-item">消火器の設置・更新・廃棄</li>
											<li class="disc-item">消火器の法定点検</li>
											<li class="disc-item">消火器に関する消防署への届出</li>
										</ol>
										<h3 class="left-bulueline-ttl">ご契約にあたって</h3>
										<p class="text fixed-area">ご契約に際しては、以下の契約約款をご確認下さい。</p>
